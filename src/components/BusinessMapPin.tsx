...
export const BusinessMapPin = () => {
  return (
    <div className="w-full max-w-5xl rounded-md mx-auto my-10 overflow-hidden shadow-lg ring-1 ring-gray-200 hover:shadow-2xl transition-shadow duration-300">
